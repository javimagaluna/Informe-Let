...
# Resumen
  ...
  A través de la exploración y visualización de datos, se evidenció los aumentos en las tasas de suicidio a medida que pasan los años 
  - rango etario con mayor tasa de suicidio desde los 70 años en adelante
  - las personas de sexo masculino son mas propensos a suicidarse que las mujeres, llegando a duplicar la tasa de mujeres.
  - instalaciones, para Guayana hay solo un hospital psiquiatrico
  - el 45,19 % tiene acceso a menos de un psiquiatra cada 100.000 habitantes
...
# Introducción
  ...
  A través de la visualización de datos se gráfica las tasas mundiales de suicidio, separando por rango etario y sexo femenino o masculino. A continuación, se analizará la accesibilidad a las instalaciones de salud mental. Luego lo contrastaremos con la cantidad de personal especializado en el área y evidenciaremos  carencias o eficiencias sistemáticas de los países. Finalmente retomaremos nuestro primer análisis de visualización y lo relacionaremos con los recursos de salud mental antes mencionados.
...
```
  En este gráfico se observa una relación positiva entre todas las variables, en donde la correlación entre años "consecutivos" aumenta. Estos valores obtenidos son muy altos, lo que nos indica que existe una conexión entre los años de las tasas de suicidio. Es interesante mirar la comparación entre el año 2016 y 2000, porque nos da indicios, gracias a la dispersión de puntos,  de como han ido aumentando las tasas de suicidio en las distintas naciones.
  
---
  
  Ahora, enfocándonos en el año 2016, realizaremos un análisis según rango de edad, en el cual, se observa, a nivel mundial, un drástico aumento en la tasa de suicidio a medida que la población adquiere mayor edad (ver Figura 2-3)
  
```{r, fig.align="center", fig.cap= "Figura 2: Tasa de suicidio promedio durante el 2016 para distintos rangos etarios  ", echo=FALSE}

knitr::include_graphics(here::here("Figuras","promedio-tasas-edad-mundo-2016.png"))
...
```
  ...
  En la Figura _, se observa un alza en las tasas para el rango entre 20 y 29 años, luego, en general, estas lineas tienden a disminuir levemente para así, volver a tener un alza desde los 70 años de edad hacia adelante. Si se realizara un estudio por promedio para esta región, el país Guyana afectaría a la estimación por tener una tasa de suicidio aproximadamente del doble que los demás países. Entonces, para los países de América del Sur,  los rangos etarios con mayor tasa de suicidio son de 20 a 29 y sobre 70. 
...
# Conclusión
  ...
  Frente a la información recaudada
