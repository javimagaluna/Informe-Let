...
# Resumen
  ...
  - el 97,5% de los 82 países poseen menos de un hospital psiquiátrico y que el 96,3% tiene menos de una unidad de salud mental en hospitales generales.
  
   - instalaciones, para Guayana hay solo un hospital psiquiátrico
...
```
  ...
  En la Figura 3, se observa un alza en las tasas para el rango entre 20 y 29 años, luego, en general, estas lineas tienden a disminuir levemente para así, volver a tener un alza desde los 70 años de edad hacia adelante. Si se realizara un estudio por promedio para esta región, el país Guyana afectaría a la estimación por tener una tasa de suicidio aproximadamente del doble que los demás países. Entonces, para los países de América del Sur,  los rangos etarios con mayor tasa de suicidio son de 20 a 29 y sobre 70. 
...
```{r, fig.align="center", echo=FALSE, fig.cap= "Figura 4"}
...
```{r, fig.align="center", echo=FALSE, fig.cap= "Figura 5"}
...
```{r, fig.align="center", echo=FALSE, fig.cap= "Figura 6"}
...
```{r, fig.align="center", echo=FALSE, fig.cap= "Figura 7"}
...
```
  ...
  En el gráfico anterior se visualiza que en general existe una mayor tasa de de unidades de salud en hospitales generales que de hospitales psiquiátricos. Además, cabe destacar que los países ubicados sobre la recta nos indican que tienen una tasa de establecimientos sumamente parecidas. 
...
```{r, fig.align="center", fig.cap= "Figura 8", echo=FALSE}
...
```{r, fig.align="center", fig.cap= "Figura 9", echo=FALSE}
...
```{r, fig.align="center", fig.cap= "Figura 10", echo=FALSE}

knitr::include_graphics(here::here("Figuras","Paises_mayor_psiq_psicol-lineas_edad.png"))
                        
```

  En esta gráfica (Fig. 10) no consideramos el país Mónaco ya que este país no figuraba en la base de datos, a pesar de esto, los demás países son muy informativos. 
...
```{r, fig.align="center", fig.cap= "Figura 11", echo=FALSE}
...
```
  ...
  Es bastante difícil inferir por qué las personas se suicidan, pero si podemos afirmar que tener accesibilidad a establecimientos hospitalarios o personal especializado es de gran ayuda. Anteriormente, mencionamos a Guyana, este país de pocos habitantes, posee sólo un hospital psiquiátrico y siete psiquiatras para toda la población, lo cual no da abasto para disminuir esta tasa.
