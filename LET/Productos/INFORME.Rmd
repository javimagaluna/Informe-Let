...
```
  ...
  En la Figura 3, se observa un alza en las tasas para el rango entre 20 y 29 años, luego, en general, estas lineas tienden a disminuir levemente para así, volver a tener un alza desde los 70 años de edad hacia adelante. Si se realizará un estudio por promedio para esta región, el país Guyana (color celeste oscuro que inicia su tasa de suicidio con un valor cercano a 20) afectaría a la estimación por tener una tasa de suicidio aproximadamente del doble que los demás países.
...
```
  ...
  En esta gráfica (Fig. 10) no consideramos el país Mónaco ya que este país no figuraba en la base de datos `tasa_suicidio_edad`. Entonces, en la Figura 10, podemos apreciar altas tasas de suicidio para el rango de 50 a 59 años, línea la cual tiende a disminuir un poco y posteriormente vuelve a aumentar rápidamente para el rango etario sobre 80 años.
...
```{r, fig.align="center", fig.cap= "Figura 11: Comparación de tasas de suicidio para paises valores extremos de psicólogos y psiquiatras ", echo=FALSE}
...
# Conclusión
  ...
  Frente a la información recaudada, vimos que las personas de sexo masculino tienden más a suicidarse que las de sexo femenino. Una explicación que se da para esta tendencia es la cultura en la que estamos inversos, en donde los hombres con su rol de superioridad, reprimen sus sentimientos y problemas llegando su punto máximo, el suicidio. Es interesante contrastar que las mujeres tienden más a tener suicidios no consumados, ya que la violencia con la que se ejerce este hecho es distinta $^{[3]}$.
  
  En relación a la cantidad de recursos en salud mental, los resultados son bastante deprimentes. Se estimó que de 104 países, el 45,19 % posee menos de un psiquiatra cada 1000.000 habitantes. Esto da hincapié a lo que se mencionó antes sobre la situación en Chile y las largas listas de espera existentes. De alguna forma podemos relacionar este bajo porcentaje de psiquiatras con el alto costo que esta posee esta profesión y su la duración, en donde se debe estudiar siete años medicina más tres años de especialización en el área. Paralelamente, se visualizó que los países con mayor cantidad de psicólogos y psiquiatras poseen menores tasas de suicidio en los rangos etarios de mayor riesgo, por lo que si podemos afirmar que el tener un mayor acceso con quien comunicar como nos sentimos produce una diferencia.
  
  Ahora hablando de los establecimientos de salud mental, se calculó que de 82 países, el 96,3% tiene menos de una unidad de salud mental en hospitales generales cada 100.000 habitantes. Esta cifra puede sonar alarmante, pero recodemos que existen muchos establecimientos que no son hospitales que se dedican a la atención mental y estos no fueron considerados para este análisis. es por ello que para tener una mejor relación causal entre variables se debe contrastar la información obtenida con otra base de datos. Por otro lado, tenemos a los hospitales psiquiátricos en donde el 97,5% de 82 países posee menos de un hospital psiquiátrico cada 100.000 habitantes. Esta cifra si es alarmante para países pequeños como Guyana, ya que, tal como mencionamos en la sección anterior, cuentan con solo un hospital psiquiátrico para todo el país, lo que evidencia las pocas políticas públicas en relación a salud mental. 
...
[4]: Pan American Health Organization / World Health Organization (2019). *OPS insta a aumentar la inversión en salud mental*.  https://www.paho.org/hq/index.php?option=com_content&view=article&id=14999:mental-health-spending-must-increase-in-order-to-meet-current-needs-in-the-americas&Itemid=1926&lang=es
